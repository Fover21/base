...
async def create_app01(name: str, description: str, sex: int, password1: str, password2: str):
    return await g.db.execute(insert(App01).values({"name": name, "description": description, "sex": sex}))
